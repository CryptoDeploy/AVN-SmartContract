...
=== AVN Contract Info  ===
    => ERC20 Compliance
    => AVN Price will increase (on buy)/ decrease (on sell) by 0.00000001 ETH
...
-------------------------------------------------------------------
 Copyright (c) 2019 avnrich .  (https://avnrich.com)
-------------------------------------------------------------------
*/
...
contract Avnrich {
    ...
    uint256 constant internal tokenPriceIncremental_ = 0.000000000007 ether;
